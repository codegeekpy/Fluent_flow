...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "bg-green-400 text-primary-foreground hover:bg-green-500/90 border-green-500 border-b-4 active:border-b-0",
        ...
        sidebar:"bg-trasparent text-slate-500 border-2 border-transparent border-0 hover:bg-slate-100 transition-none",
